...
test('Check controller counts', function(assert) {
...
test('Check controller sorted user groups', function(assert) {
...
test('Should be able to sign in with attempted transition', function(assert) {
