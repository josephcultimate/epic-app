...
App.PersonController = Ember.ArrayController.extend({
    ...
    empty: function() {
        return 0 === this.employees.get("length") && 0 === this.managers.get("length") && 0 === this.managersadmins.get("length") && 0 === this.employeesadmins.get("length");
    }.property("length"),
    ...
    msg_warning: null,
    _linkToProfile: function(a) {
        var b = this;
        b.send("resetmsg");
        var c = {
            username: "test"
        }, d = App.PostRequest.create({
            endpointRoute: "/login",
            data: JSON.stringify(c)
        }), e = a.get("id"), f = App.post(d);
        f.then(b.onLoginSuccess(e), this.onLoginError());
    },
    onLoginSuccess: function(a) {
        var b = this;
        return function(c) {
            App.setSessionToken(c.session_token);
            var d = b.get("attemptedTransition");
            d ? (d.retry(), b.set("attemptedTransition", null)) : b.transitionToRoute("profile", a);
        };
    },
    onLoginError: function() {
        var a = this;
        return function(b) {
            a.set("msg_warning", b.responseJSON.error.message);
        };
    },
    actions: {
        linktoprofile: function(a) {
            this._linkToProfile(a);
        },
        resetmsg: function() {
            var a = this;
            a.set("msg_warning", null);
        }
    }
}), App.EmployeesController = App.PersonController.extend(), App.ManagersController = App.PersonController.extend(), 
App.ManadminsController = App.PersonController.extend(), App.EmpadminsController = App.PersonController.extend(), 
App.Person = DS.Model.extend(Ember.Validations.Mixin, {
    ...
    hasFirstName: function() {
        return "undefined" != typeof this.get("first_name") && this.get("first_name").length > 0;
    }.property("first_name"),
    fullname: function() {
    ...
    isInRole: function(a) {
        return (this.get("roles") & a) === a;
    },
    pictureLink: function() {
        var a = App.normalizeRelativePath("/assets/person_40x40.png");
    ...
    redirectToLogin: function(a) {
        var b = this.controllerFor("person");
        b.set("attemptedTransition", a), this.transitionTo("employees");
    },
    actions: {
        error: function(a, b) {
    ...
    setupController: function(a) {
        a.send("resetmsg"), a.set("employees", this._filterByRole(1)), a.set("managers", this._filterByRole(2)), 
        a.set("managersadmins", this._filterByRole(6)), a.set("employeesadmins", this._filterByRole(5));
    },
    _filterByRole: function(a) {
        var b = this;
        return b.store.filter("person", this._getFilterCallback(a));
    },
    _filterByRoleHelper: function(a, b) {
        return a.get("roles") === b;
    },
    _getFilterCallback: function(a) {
        var b = this;
        return function(c) {
            return b._filterByRoleHelper(c, a);
        };
    }
}), App.ManagersRoute = App.PersonRoute.extend({
    setupController: function(a) {
        this._super(a), a.set("model", a.managers);
    }
}), App.ManadminsRoute = App.PersonRoute.extend({
    setupController: function(a) {
        this._super(a), a.set("model", a.managersadmins);
    }
}), App.EmployeesRoute = App.PersonRoute.extend({
    setupController: function(a) {
        this._super(a), a.set("model", a.employees);
    }
}), App.EmpadminsRoute = App.PersonRoute.extend({
    setupController: function(a) {
        this._super(a), a.set("model", a.employeesadmins);
    }
});