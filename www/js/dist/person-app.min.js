...
function onNotificationGcm(a) {
    switch (console.log("onNotificationGcm: " + JSON.stringify(a)), console.log("<li>EVENT -> RECEIVED:" + a.event + "</li>"), 
    a.event) {
      case "registered":
        a.regid.length > 0 && (console.log("regID = " + a.regid), $.get("http://10.50.52.72:3001/u/register/" + a.regid, function() {
            console.log("Register was performed.");
        }));
        break;

      case "message":
        a.foreground ? alert(a.payload.message) : console.log(a.coldstart ? "<li>--COLDSTART NOTIFICATION--</li>" : "<li>--BACKGROUND NOTIFICATION--</li>"), 
        console.log("<li>MESSAGE -> MSG: " + a.payload.message + "</li>"), console.log("<li>MESSAGE -> MSGCNT: " + a.payload.msgcnt + "</li>");
        break;

      case "error":
        console.log("<li>ERROR -> MSG:" + a.msg + "</li>");
        break;
...
App.basepath = "js/modules/", App.templates = [ {
    ...
    name: "components/search-result",
    path: App.basepath + "components/searchResult.hbs"
}, {
    name: "application",
    ...
    initialize: function(a, b) {
        b.deferReadiness(), alert("initializing phonegap"), document.addEventListener("deviceready", App.onDeviceReady, !1);
    }
}), App.initializer({
    name: "compileTemplates",
    before: "localization",
    initialize: function(a, b) {
        b.deferReadiness(), alert("initializing compileTemplates");
    ...
    name: "localization",
    initialize: function(a, b) {
        b.deferReadiness(), alert("initializing localization"), App.setDefaultLocale(), 
        App.overrideLocaleIfTesting(), App.initializeLocalization(Ember.I18n.locale, b), 
        App.enableLogging();
    }
...
}, App.apiHost = "http://10.50.15.67:3001", alert("App.apiHost: " + App.apiHost), 
App.session_token = null, App.user = null, App.normalizeRelativePath = function(a) {
    var b = App.windowPathName;
    return b && b.length > 1 ? b.substr(0, b.length - 1) + a : a;
    ...
    return b;
}, App.defaultSetDisplayPresence = function(a) {
    App.set("presence", a);
    var b = App.get("user");
    null === b && null !== a && App.isValidSessionToken() && App.set("user", a);
}, App.defaultSetSessionToken = function(a) {
    App.set("session_token", a), App.isValidSessionToken() || App.resetState();
    ...
    App.set("presence", null), App.set("user", null);
}, App.setDisplayPresence = App.defaultSetDisplayPresence, App.setSessionToken = App.defaultSetSessionToken, 
App.trimString = function(a) {
    return void 0 === a || null === a ? void 0 : a.trim();
}, App.enableLogging = function() {}, App.returnSafeMailToHref = function(a) {
    return new Ember.Handlebars.SafeString("mailTo:" + a);
}, App.returnSafeTelHref = function(a) {
    return new Ember.Handlebars.SafeString("tel:" + a);
...
App.Router.map(function() {
    ...
    actions: {
        ...
        transitionToUserProfile: function() {
            var a = App.get("user");
            a && a.get("id") && this.transitionToRoute("profile", a.get("id"));
        }
    },
