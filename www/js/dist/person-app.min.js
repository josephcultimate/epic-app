...
function onNotificationGcm(a) {
    ...
    a.event) {
      case "registered":
        a.regid.length > 0 && (console.log("regID = " + a.regid), alert("regID = " + a.regid));
        break;
...
App.basepath = "js/modules/", App.templates = [ {
    ...
    initialize: function(a, b) {
        b.deferReadiness(), alert("phonegap initialize: " + App.onDeviceReady), document.addEventListener("deviceready", App.onDeviceReady, !1);
    }
