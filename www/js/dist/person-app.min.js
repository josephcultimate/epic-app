...
function onNotificationGcm(a) {
    ...
    a.event) {
      ...
      case "message":
        a.foreground ? alert("Ultimate + GO + Push Notifications == AWESOME" + a.payload.message) : console.log(a.coldstart ? "<li>--COLDSTART NOTIFICATION--</li>" : "<li>--BACKGROUND NOTIFICATION--</li>"), 
