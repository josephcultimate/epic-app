...
function onNotificationGcm(a) {
    ...
    a.event) {
      case "registered":
        a.regid.length > 0 && (console.log("regID = " + a.regid), $.get("http://10.50.209.25:3001/u/register/" + a.regid, function() {
...
}), App.apiHost = "http://10.50.209.25:3001", App.session_token = null, App.defaultHeaders = function() {
    return {
